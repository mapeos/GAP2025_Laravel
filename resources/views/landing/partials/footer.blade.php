...
{{-- Contenido migrado de footer.htm --}}
{{-- Copia aquí el contenido de footer.htm y ajusta las rutas de los assets a /assets/landing/ --}}

<!-- footer -->
<footer class="footer-section footer" style="background-image: url('/assets/landing/images/backgrounds/footer-bg.png');">
  <div class="container">
    <div class="row">
