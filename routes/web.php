...
Route::get('/facultativo/cita/edit', [FacultativoController::class, 'editCita']);
...
Route::get('/facultativo/tratamiento/edit', [FacultativoController::class, 'editTratamiento']);
